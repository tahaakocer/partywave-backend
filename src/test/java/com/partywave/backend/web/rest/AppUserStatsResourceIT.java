...
class AppUserStatsResourceIT {
    ...
    void getAllAppUserStats() throws Exception {
        ...
        restAppUserStatsMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(appUserStats.getId().toString())))
    ...
    void getAppUserStats() throws Exception {
        ...
        restAppUserStatsMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(appUserStats.getId().toString()))
    ...
    void getNonExistingAppUserStats() throws Exception {
        // Get the appUserStats
        restAppUserStatsMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void putNonExistingAppUserStats() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        appUserStats.setId(UUID.randomUUID());
    ...
    void deleteAppUserStats() throws Exception {
        ...
        restAppUserStatsMockMvc
            .perform(delete(ENTITY_API_URL_ID, appUserStats.getId().toString()).accept(MediaType.APPLICATION_JSON))
