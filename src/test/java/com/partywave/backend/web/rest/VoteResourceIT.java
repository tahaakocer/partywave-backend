...
class VoteResourceIT {
    ...
    public static Vote createEntity() {
        return new Vote().voteType(DEFAULT_VOTE_TYPE).playlistItemId(DEFAULT_PLAYLIST_ITEM_ID).createdAt(DEFAULT_CREATED_AT);
    }
    ...
    public static Vote createUpdatedEntity() {
        return new Vote().voteType(UPDATED_VOTE_TYPE).playlistItemId(UPDATED_PLAYLIST_ITEM_ID).createdAt(UPDATED_CREATED_AT);
    }
    ...
    void putExistingVote() throws Exception {
        ...
        updatedVote.voteType(UPDATED_VOTE_TYPE).playlistItemId(UPDATED_PLAYLIST_ITEM_ID).createdAt(UPDATED_CREATED_AT);
    ...
    void putWithIdMismatchVote() throws Exception {
        ...
        restVoteMockMvc
            .perform(
                put(ENTITY_API_URL_ID, UUID.randomUUID()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(voteDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void partialUpdateVoteWithPatch() throws Exception {
        ...
        partialUpdatedVote.playlistItemId(UPDATED_PLAYLIST_ITEM_ID).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateVoteWithPatch() throws Exception {
        ...
        partialUpdatedVote.voteType(UPDATED_VOTE_TYPE).playlistItemId(UPDATED_PLAYLIST_ITEM_ID).createdAt(UPDATED_CREATED_AT);
