...
class RefreshTokenResourceIT {
    ...
    void getAllRefreshTokens() throws Exception {
        ...
        restRefreshTokenMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(refreshToken.getId().toString())))
    ...
    void getRefreshToken() throws Exception {
        ...
        restRefreshTokenMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(refreshToken.getId().toString()))
    ...
    void getNonExistingRefreshToken() throws Exception {
        // Get the refreshToken
        restRefreshTokenMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void deleteRefreshToken() throws Exception {
        ...
        restRefreshTokenMockMvc
            .perform(delete(ENTITY_API_URL_ID, refreshToken.getId().toString()).accept(MediaType.APPLICATION_JSON))
