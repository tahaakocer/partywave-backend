...
class AppUserImageResourceIT {
    ...
    void getAllAppUserImages() throws Exception {
        ...
        restAppUserImageMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(appUserImage.getId().toString())))
    ...
    void getAppUserImage() throws Exception {
        ...
        restAppUserImageMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(appUserImage.getId().toString()))
    ...
    void getNonExistingAppUserImage() throws Exception {
        // Get the appUserImage
        restAppUserImageMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void putNonExistingAppUserImage() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        appUserImage.setId(UUID.randomUUID());
    ...
    void deleteAppUserImage() throws Exception {
        ...
        restAppUserImageMockMvc
            .perform(delete(ENTITY_API_URL_ID, appUserImage.getId().toString()).accept(MediaType.APPLICATION_JSON))
