...
class RoomInvitationResourceIT {
    ...
    void getAllRoomInvitations() throws Exception {
        ...
        restRoomInvitationMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(roomInvitation.getId().intValue())))
    ...
    void getRoomInvitation() throws Exception {
        ...
        restRoomInvitationMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(roomInvitation.getId().intValue()))
    ...
    void getNonExistingRoomInvitation() throws Exception {
        // Get the roomInvitation
        restRoomInvitationMockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    void putNonExistingRoomInvitation() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        roomInvitation.setId(longCount.incrementAndGet());
    ...
    void deleteRoomInvitation() throws Exception {
        ...
        restRoomInvitationMockMvc
            .perform(delete(ENTITY_API_URL_ID, roomInvitation.getId()).accept(MediaType.APPLICATION_JSON))
