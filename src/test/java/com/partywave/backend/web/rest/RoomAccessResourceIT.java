...
class RoomAccessResourceIT {
    ...
    void getAllRoomAccesses() throws Exception {
        ...
        restRoomAccessMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(roomAccess.getId().intValue())))
    ...
    void getRoomAccess() throws Exception {
        ...
        restRoomAccessMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(roomAccess.getId().intValue()))
    ...
    void getNonExistingRoomAccess() throws Exception {
        // Get the roomAccess
        restRoomAccessMockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    void putNonExistingRoomAccess() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        roomAccess.setId(longCount.incrementAndGet());
    ...
    void deleteRoomAccess() throws Exception {
        ...
        restRoomAccessMockMvc
            .perform(delete(ENTITY_API_URL_ID, roomAccess.getId()).accept(MediaType.APPLICATION_JSON))
