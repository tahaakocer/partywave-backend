package com.partywave.backend.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.partywave.backend.IntegrationTest;
import com.partywave.backend.repository.timezone.DateTimeWrapper;
import com.partywave.backend.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM pw_date_time_wrapper where id=%d", fieldName, id);
    }
