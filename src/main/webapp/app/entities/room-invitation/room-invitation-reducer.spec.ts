...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMINVITATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ROOMINVITATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ROOMINVITATION actions', async () => {
      const arg = { id: '4c9a4abb-b470-4373-8198-9e8e69198a04' };
    ...
    it('dispatches UPDATE_ROOMINVITATION actions', async () => {
      const arg = { id: '4c9a4abb-b470-4373-8198-9e8e69198a04' };
    ...
    it('dispatches PARTIAL_UPDATE_ROOMINVITATION actions', async () => {
    ...
    it('dispatches DELETE_ROOMINVITATION actions', async () => {
      const arg = 42666;
