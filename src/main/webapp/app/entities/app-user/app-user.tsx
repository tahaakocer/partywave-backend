          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="partywaveApp.appUser.stats">Stats</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {appUserList.map((appUser, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{appUser.stats ? <Link to={`/app-user-stats/${appUser.stats.id}`}>{appUser.stats.id}</Link> : ''}</td>
