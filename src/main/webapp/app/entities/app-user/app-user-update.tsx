...
export const AppUserUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    const entity = {
      ...appUserEntity,
      ...values,
      stats: appUserStats.find(it => it.id.toString() === values.stats?.toString()),
    };
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="app-user-id"
                  label={translate('partywaveApp.appUser.id')}
              ...
              <ValidatedField
                ...
                name="stats"
                data-cy="stats"
                label={translate('partywaveApp.appUser.stats')}
                type="select"
              >
                <option value="" key="0" />
                {appUserStats
