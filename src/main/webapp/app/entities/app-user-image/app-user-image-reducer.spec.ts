...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPUSERIMAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPUSERIMAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPUSERIMAGE actions', async () => {
      const arg = { id: '5e559fab-d9d6-4999-ac1d-abaca107954e' };
    ...
    it('dispatches UPDATE_APPUSERIMAGE actions', async () => {
      const arg = { id: '5e559fab-d9d6-4999-ac1d-abaca107954e' };
    ...
    it('dispatches PARTIAL_UPDATE_APPUSERIMAGE actions', async () => {
    ...
    it('dispatches DELETE_APPUSERIMAGE actions', async () => {
      const arg = 42666;
