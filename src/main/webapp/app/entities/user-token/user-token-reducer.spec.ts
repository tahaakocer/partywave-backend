...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERTOKEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERTOKEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERTOKEN actions', async () => {
      const arg = { id: '3045e354-57a2-47bd-aa6c-3fa16efbe13f' };
    ...
    it('dispatches UPDATE_USERTOKEN actions', async () => {
      const arg = { id: '3045e354-57a2-47bd-aa6c-3fa16efbe13f' };
    ...
    it('dispatches PARTIAL_UPDATE_USERTOKEN actions', async () => {
    ...
    it('dispatches DELETE_USERTOKEN actions', async () => {
      const arg = 42666;
