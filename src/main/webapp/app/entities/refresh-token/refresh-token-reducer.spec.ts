...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REFRESHTOKEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REFRESHTOKEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REFRESHTOKEN actions', async () => {
      const arg = { id: '62181c56-9be0-4a7f-b06b-5f44c5679987' };
    ...
    it('dispatches UPDATE_REFRESHTOKEN actions', async () => {
      const arg = { id: '62181c56-9be0-4a7f-b06b-5f44c5679987' };
    ...
    it('dispatches PARTIAL_UPDATE_REFRESHTOKEN actions', async () => {
    ...
    it('dispatches DELETE_REFRESHTOKEN actions', async () => {
      const arg = 42666;
