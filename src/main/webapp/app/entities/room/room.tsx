  ...
  return (
    <div>
      <h2 id="room-heading" data-cy="RoomHeading">
        <Translate contentKey="partywaveApp.room.home.title">Rooms</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="partywaveApp.room.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/room/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="partywaveApp.room.home.createLabel">Create new Room</Translate>
          </Link>
        </div>
      </h2>
          ...
          {roomList && roomList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="partywaveApp.room.id">Id</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                  </th>
              ...
              <tbody>
                {roomList.map((room, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>{room.isPublic ? 'true' : 'false'}</td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="partywaveApp.room.home.notFound">No Rooms found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
