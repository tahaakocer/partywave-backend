...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPUSERSTATS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPUSERSTATS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPUSERSTATS actions', async () => {
      const arg = { id: '5310f0dd-b929-400c-b5dd-7b535ff4f3ba' };
    ...
    it('dispatches UPDATE_APPUSERSTATS actions', async () => {
      const arg = { id: '5310f0dd-b929-400c-b5dd-7b535ff4f3ba' };
    ...
    it('dispatches PARTIAL_UPDATE_APPUSERSTATS actions', async () => {
    ...
    it('dispatches DELETE_APPUSERSTATS actions', async () => {
      const arg = 42666;
