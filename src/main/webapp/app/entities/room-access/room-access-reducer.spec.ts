...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMACCESS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ROOMACCESS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ROOMACCESS actions', async () => {
      const arg = { id: '012af4ad-defa-4f52-81b6-e4e605b4d322' };
    ...
    it('dispatches UPDATE_ROOMACCESS actions', async () => {
      const arg = { id: '012af4ad-defa-4f52-81b6-e4e605b4d322' };
    ...
    it('dispatches PARTIAL_UPDATE_ROOMACCESS actions', async () => {
    ...
    it('dispatches DELETE_ROOMACCESS actions', async () => {
      const arg = 42666;
