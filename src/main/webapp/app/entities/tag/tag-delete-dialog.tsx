...
export const TagDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="partywaveApp.tag.delete.question">
        <Translate contentKey="partywaveApp.tag.delete.question" interpolate={{ id: tagEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="pw-confirm-delete-tag" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
