...
public class RoomAccessResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<RoomAccessDTO> createRoomAccess(@RequestBody RoomAccessDTO roomAccessDTO) throws URISyntaxException {
    ...
    public ResponseEntity<RoomAccessDTO> updateRoomAccess(
        ...
        @RequestBody RoomAccessDTO roomAccessDTO
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<RoomAccessDTO> getRoomAccess(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteRoomAccess(@PathVariable("id") Long id) {
