...
public class RoomInvitationResource {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<RoomInvitationDTO> getRoomInvitation(@PathVariable("id") UUID id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteRoomInvitation(@PathVariable("id") UUID id) {
