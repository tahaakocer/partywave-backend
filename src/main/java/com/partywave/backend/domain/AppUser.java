...
public class AppUser implements Serializable {
    ...
    public AppUserStats getStats() {
        return this.stats;
    }

    public void setStats(AppUserStats appUserStats) {
        this.stats = appUserStats;
    }

    public AppUser stats(AppUserStats appUserStats) {
        this.setStats(appUserStats);
        return this;
    }
